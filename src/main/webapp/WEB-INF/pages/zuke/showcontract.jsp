        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <br/>
                    <!-- form start -->
                    <form name="hetong" action="#">
                        <div class="title">房屋租赁合同</div>
                        <input type="hidden" name="house_id" value="${contract.house_id}"/>
                        <p>出租方：<span name="chuzu"><strong>${contract.chuzu}</strong></span>（以下简称甲方）；</p>　　　
                        <p>承租方：<span name="zuke"><strong>${contract.zuke}</strong></span>（以下简称乙方）。　</p>　
                        <p>租赁房屋地址：<span name="zuke"><strong>${contract.address}</strong></span>　</p>　
                        <p>依据《中华人民共和国合同法》有关条款，甲乙双方经过充分协商，就乙方租赁甲方房屋事宜达成如下协议：</p>
                        <p>一、乙方租赁甲方房屋，以下简称租赁房屋。</p>
                        <p>二、起租时间：<span name="fromdate"><strong>${contract.fromdate}</strong></span>，退租时间：<span
